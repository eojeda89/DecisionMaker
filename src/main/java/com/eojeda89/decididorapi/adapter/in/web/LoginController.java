...
public class LoginController {
    ...
    @Operation(summary = "Autentica un usuario y devuelve un JWT", description = "El token debe enviarse como header 'Authorization: Bearer <token>' en las siguientes requests a /api/**.")
